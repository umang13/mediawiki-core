 ...
 */
$messages['qqq'] = array(
	'mwe-loading' => 'Used in a Loading dialog.
{{Identical|Loading}}',
	'mwe-size-gigabytes' => '{{optional}}
Parameters:
* $1 - size (of a file, typically) in gibibytes (1 gibibyte = 1024×1024×1024 bytes).
See also:
...
* $1 - the JavaScript file that was not retrievable or does not define its class name
* $2 - the class name that was associated with the JavaScript file that was not found or could not be retrieved',
	'mwe-ok' => '{{Identical|OK}}',
	'mwe-cancel' => '{{Identical|Cancel}}',
	'mwe-must-login-gadget' => 'Unused at this time. Parameters:
* $1 - URL',
	'mwe-test-plural' => 'Unused at this time. Parameters:
* $1 - number of tests',
);
...
$messages['ast'] = array(
	...
	'mwe-error_load_lib' => 'Error: el ficheru JavaScript $1 nun pudo recuperase o nun define $2',
	'mwe-apiproxy-setup' => "Configurando'l proxy de la API",
	'mwe-load-drag-item' => "Cargando l'elementu arrastráu",
	'mwe-ok' => 'Aceutar',
	'mwe-cancel' => 'Encaboxar',
	'mwe-enable-gadget' => 'Activar multimedia beta (mwEmbed) en toles páxines',
	'mwe-enable-gadget-done' => "Activóse l'accesoriu multimedia beta",
	'mwe-must-login-gadget' => 'P\'activar l\'accesoriu tien d\'<a target="_new" href="$1">aniciar sesión</a>',
	'mwe-test-plural' => 'Executé {{PLURAL:$1|$1 prueba|$1 pruebes}}',
);
...
$messages['frp'] = array(
	'mwe-loading' => 'Chargement ...',
	'mwe-error_load_lib' => 'Fôta : JavaScript $1 at pas possu étre trovâ ou ben dèfenét pas $2',
	'mwe-apiproxy-setup' => 'Configuracion du proxy API',
	'mwe-load-drag-item' => 'Chargement de l’èlèment dèposeâ',
	'mwe-ok' => 'D’acôrd',
	'mwe-cancel' => 'Anular',
	'mwe-enable-gadget' => 'Activar la bèta de l’outil multimèdia (mwEmbed) sur totes les pâges',
	'mwe-enable-gadget-done' => 'La bèta de l’outil multimèdia est étâye activâye',
	'mwe-must-login-gadget' => 'Por activar l’outil vos vos dête <a target="_new" href="$1">branchiér</a>',
 ...
 */
$messages['ka'] = array(
	'mwe-loading' => 'იტვირთება…',
	'mwe-size-gigabytes' => '$1 გბ',
	'mwe-size-megabytes' => '$1 მბ',
	'mwe-size-kilobytes' => '$1 კ',
	'mwe-size-bytes' => '$1 ბ',
	'mwe-apiproxy-setup' => 'API პროქსის პარამეტრები',
	'mwe-ok' => 'კარგი',
	'mwe-cancel' => 'გაუქმება',
	'mwe-must-login-gadget' => 'გაჯეტის ჩასართავად თქვენ უნდა <a target="_new" href="$1">შეხვიდეთ</a>',
);
...
$messages['ml'] = array(
	...
	'mwe-enable-gadget' => 'എല്ലാ താളുകളിലും മൾട്ടിമീഡിയ ബീറ്റ (mwEmbed) സജ്ജമാക്കുക',
	'mwe-enable-gadget-done' => 'മൾട്ടിമീഡിയ ബീറ്റ ഗാഡ്ജെറ്റ് സജ്ജമാക്കിയിരിക്കുന്നു',
	'mwe-must-login-gadget' => 'ഗാഡ്ജറ്റ് സജ്ജമാക്കാൻ താങ്കൾ <a target="_new" href="$1">പ്രവേശിച്ചിരിക്കണം</a>',
	'mwe-test-plural' => 'ഞാൻ {{PLURAL:$1|ഒരു പരീക്ഷണം|$1 പരീക്ഷണങ്ങൾ}} നടത്തി',
);
 ...
 */
$messages['ms'] = array(
	'mwe-loading' => 'Memuatkan...',
	'mwe-error_load_lib' => 'Ralat: JavaScript $1 tidak dapat diperoleh atau tidak mentakrifkan $2',
	'mwe-apiproxy-setup' => 'Menyiapkan proksi API',
	'mwe-load-drag-item' => 'Perkara yang diseret sedang dimuatkan',
	'mwe-ok' => 'OK',
	'mwe-cancel' => 'Batalkan',
	'mwe-enable-gadget' => 'Bolehkan beta multimedia (mwEmbed) untuk semua halaman',
	'mwe-enable-gadget-done' => 'Gajet beta multimedia telah dibolehkan',
	'mwe-must-login-gadget' => 'Untuk membolehkan gajet, anda mesti <a target="_new" href="$1">log masuk</a>',
	'mwe-test-plural' => 'Saya telah menjalankan $1 ujian',
);
...
$messages['mt'] = array(
	'mwe-loading' => "Tiela'...",
	'mwe-apiproxy-setup' => 'Konfigurazzjoni tal-proxy API',
	'mwe-ok' => 'OK',
	'mwe-cancel' => 'Annulla',
);
...
$messages['pt'] = array(
	...
	'mwe-enable-gadget-done' => 'Gadget beta de multimídia foi ativado',
	'mwe-must-login-gadget' => 'Para ativar o gadget tem de estar <a target="_new" href="$1">autenticado</a>',
...
$messages['roa-tara'] = array(
	'mwe-loading' => 'Stoche a scareche…',
	'mwe-error_load_lib' => "Errore: 'U JavaScript $1 non g'ha state acchiate o non g'ha state definite $2",
	'mwe-apiproxy-setup' => "'Mbostazione de le API d'u proxy",
	'mwe-load-drag-item' => 'Stoche a scareche le vôsce trascinabbile',
	'mwe-ok' => 'OK',
	'mwe-cancel' => 'Annulle',
	'mwe-enable-gadget' => "Abbilite 'a beta multimedia (mwEmbed) pe tutte le pàggene",
	'mwe-enable-gadget-done' => "'U dispositive beta de multimedia ha state abbilitate",
	'mwe-must-login-gadget' => 'Pe abbilità \'u dispositive tu a <a target="_new" href="$1">trasè</a>',
	'mwe-test-plural' => 'Agghie eseguite {{PLURAL:$1|$1 test}}',
);
 ...
 */
$messages['si'] = array(
	'mwe-loading' => 'පූරණය වෙමින්...',
	'mwe-apiproxy-setup' => 'API පෙරකලාසි සකසමින්',
	'mwe-load-drag-item' => 'ඇදගත් අයිතම පූරණය කරමින්',
	'mwe-ok' => 'හරි',
	'mwe-cancel' => 'අත් හරින්න',
);
 ...
 */
$messages['ta'] = array(
	'mwe-loading' => 'ஏற்றுகிறது...',
	'mwe-ok' => 'சரி',
	'mwe-cancel' => 'ரத்து செய்',
);
...
$messages['uk'] = array(
	...
	'mwe-error_load_lib' => 'Помилка: JavaScript $1 не підлягає відновленню або не визначає $2',
	'mwe-apiproxy-setup' => 'Налаштування проксі API',
	'mwe-load-drag-item' => 'Завантаження пересунутого елемента',
	'mwe-ok' => 'Гаразд',
	'mwe-cancel' => 'Скасувати',
	'mwe-enable-gadget' => 'Увімкнути  бета-мультимедію (mwEmbed) для всіх сторінок',
	'mwe-enable-gadget-done' => 'Увімкнена бета-версія мультимедійної новинки.',
	'mwe-must-login-gadget' => 'Щоб увімкнути новинку, ви повинні <a target="_new" href="$1">увійти</a>',
	'mwe-test-plural' => 'Я пройшов {{PLURAL:$1|$1 тест|$1 тести|тестів}}',
);
